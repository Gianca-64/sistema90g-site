...
BRANCH="visual-system-v11-strategic-guide-pilot"
PORT="4183"
BASE_URL="http://127.0.0.1:${PORT}"
ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
CHROME="/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
OUT="$HOME/Desktop/Sistema90G-Strategic-Guide-Visual-V1-Audit"
...
python3 -m http.server "$PORT" --bind 127.0.0.1 --directory dist >/tmp/s90g-strategic-guide-v1-audit-preview.log 2>&1 &
server_pid=$!
...
Sistema 90G — Strategic Guide Visual V1 audit locale
Branch: $BRANCH
Pagina: $BASE_URL/errori-progetto-cucina.html
...
File:
- strategic-guide-errors-full-desktop.png
- strategic-guide-errors-full-mobile.png
- metrics.json
EOF
...
echo
echo "STRATEGIC GUIDE VISUAL V1: GATE LOCALE COMPLETATO."
echo "Risultati: $OUT"
