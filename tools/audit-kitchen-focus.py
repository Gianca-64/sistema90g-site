...
ID HTML e sitemap. Non sostituisce il collaudo visivo o il test end-to-end.
"""
...
SERVICES = {
    "controllo-mirato": {"code": "S90G-K01", "price": "127"},
    "analisi-completa": {"code": "S90G-K02", "price": "253"},
    "acquisto-assistito-cucina": {"code": "S90G-K03", "price": "290"},
}
