...
- Pagine HTML controllate: **133**
- File immagine presenti: **199**
- Immagini di contenuto pubblicate: **188**
- Asset riutilizzati in più punti (da valutare, non errore): **45**
...
| `acquisto-assistito-cucina.html` | `images/progetto-cucina-90g-report-20260817.png` | Prima dell'acquisto verifichiamo gratuitamente se lo Sviluppo avanzato aggiunge valore reale oppure se il progetto base è già sufficiente. | Sviluppo avanzato del Progetto Cucina Sistema 90G |
| `acquisto-assistito-cucina.html` | `images/progetto-cucina-90g-report-20260817.png` | Descrivi la situazione e il materiale disponibile. La valutazione iniziale è gratuita: ti diciamo se è sufficiente il Progetto Cucina base o | Elaborati e visualizzazioni del Progetto Cucina 90G |
| `agenzie-immobiliari-cucina.html` | `images/25_PER_AGENZIE_COLLABORAZIONE.jpg` | La prima valutazione serve a capire gratuitamente se il dubbio sulla cucina è pertinente e quale approfondimento può essere utile. Non attiv | Collaborazione con agenzia immobiliare per comprendere le possibilità della cucina in un immobile |
| `agenzie-immobiliari-cucina.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia la domanda concreta del cliente e il materiale disponibile. La prima valutazione è gratuita e serve a capire se esiste davvero un appr | Materiale per valutare il potenziale cucina di un immobile |
...
| `analisi-preventiva.html` | `images/03_HOME_METODO.jpg` | La prima valutazione è gratuita. Non avvia alcun acquisto e non ti obbliga a proseguire. | Prima valutazione di un problema reale relativo alla cucina |
...
| `casi-analizzati.html` | `images/19_CASI_CUCINA.jpg` | La prima valutazione serve a capire se e come approfondire. Non avvia automaticamente un servizio a pagamento. | Archivio casi cucina Sistema 90G |
| `casi-analizzati.html` | `images/caso-lavastoviglie-passaggio-cucina.jpg` | Situazioni diverse, con un principio comune: individuare prima il punto che merita davvero attenzione. | Lavastoviglie e passaggio |
...
| `casi-analizzati.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | L'invio iniziale non attiva alcun acquisto. Se il caso richiede un lavoro professionale, percorso, contenuti e prezzo vengono indicati prima | Materiali per una prima valutazione cucina |
...
| `caso-camera-bambini-crescita.html` | `images/caso-camera-bambini-crescita.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 13 luglio 2026 | Cameretta con letto a castello, armadio e scrivania da verificare |
| `caso-camera-bambini-crescita.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, misure della stanza e disposizione prevista di letto, armadio e scrivania. | Raccolta di planimetria e misure per una cameretta |
| `caso-corridoio-porte-aperte.html` | `images/caso-corridoio-porte-aperte.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 13 luglio 2026 | Corridoio di distribuzione con più porte da verificare |
| `caso-corridoio-porte-aperte.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria quotata e verso di apertura previsto per ogni porta. | Raccolta di planimetria e misure per un corridoio |
| `caso-cucina-piccola-tre-lati.html` | `images/caso-cucina-piccola-tre-lati.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Cucina piccola su tre lati con passaggi e aperture da verificare |
| `caso-cucina-profondita-75-angolo.html` | `images/caso-cucina-profondita-75-angolo.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Cucina ad angolo con profondità maggiorata e contenimento da verificare |
...
| `caso-ingresso-tavolo-living.html` | `images/caso-ingresso-tavolo-living.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 7 luglio 2026 | Ingresso vicino al tavolo e zona giorno compressa |
| `caso-ingresso-tavolo-living.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, fotografie e disposizione proposta. Descrivi quale problema vuoi risolvere. | Raccolta di planimetria e fotografie della zona giorno |
| `caso-isola-passaggi-cucina.html` | `images/caso-isola-passaggi-cucina.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Isola cucina con passaggi, sedute e aperture da verificare |
| `caso-lavanderia-oblo-porta.html` | `images/caso-lavanderia-oblo-porta.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 13 luglio 2026 | Vano lavanderia con lavatrice e asciugatrice da verificare |
| `caso-lavanderia-oblo-porta.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, misure del vano e modello previsto di lavatrice e asciugatrice. | Raccolta di planimetria e misure per una lavanderia |
| `caso-lavastoviglie-passaggio-cucina.html` | `images/caso-lavastoviglie-passaggio-cucina.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Lavastoviglie aperta che riduce il passaggio in cucina |
| `caso-lavello-sotto-finestra-aperture.html` | `images/caso-lavello-sotto-finestra-aperture.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Lavello sotto finestra con possibile conflitto tra rubinetto e infisso |
| `caso-open-space-percorso-centrale.html` | `images/caso-open-space-percorso-centrale.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Open space attraversato dal percorso verso la zona notte |
| `caso-open-space-percorso-centrale.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, fotografie e indicazione delle funzioni che devono convivere. | Raccolta di planimetria e fotografie della zona giorno |
| `caso-open-space-tv-divano-passaggi.html` | `images/caso-open-space-tv-divano-passaggi.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 7 luglio 2026 | Open space con TV, divano e passaggio centrale |
| `caso-open-space-tv-divano-passaggi.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, fotografie e dimensioni degli arredi che stai valutando. | Raccolta di planimetria e misure della zona giorno |
| `caso-preventivo-cucina-sconto-valore.html` | `images/22_CASI_PREVENTIVO.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 7 luglio 2026 | Preventivo cucina con voci e materiali da verificare |
| `caso-ripostiglio-profondita-scaffali.html` | `images/caso-ripostiglio-profondita-scaffali.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 13 luglio 2026 | Ripostiglio con scaffalature profonde da verificare |
| `caso-ripostiglio-profondita-scaffali.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, misure del vano e verso di apertura della porta. | Raccolta di planimetria e misure per un ripostiglio |
| `caso-scala-interna-terrazzo-planimetria.html` | `images/caso-scala-interna-terrazzo-planimetria.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Planimetria con scala interna verso il terrazzo |
| `caso-scala-interna-terrazzo-planimetria.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetrie dei livelli, fotografie e obiettivi principali. | Raccolta di planimetrie e fotografie per una scala interna |
| `caso-secondo-bagno-impianti-spazio.html` | `images/caso-secondo-bagno-impianti-spazio.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Secondo bagno ricavato vicino agli ambienti esistenti |
| `caso-secondo-bagno-impianti-spazio.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, fotografie e indicazioni sugli impianti disponibili. Descrivi quale ambiente non vuoi compromettere. | Raccolta di planimetria e informazioni sugli impianti |
| `caso-soffitta-altezza-utile.html` | `images/caso-soffitta-altezza-utile.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 13 luglio 2026 | Soffitta sotto falda con altezza utile da verificare |
| `caso-soffitta-altezza-utile.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, sezione della falda e misure dell'accesso. | Raccolta di planimetria e misure per una soffitta |
| `caso-soggiorno-pianoforte-tavolo-divano-tv.html` | `images/caso-soggiorno-pianoforte-tavolo-divano-tv.jpg` | Analisi di Gian Carlo Primo · Aggiornato l'8 luglio 2026 | Soggiorno con tavolo, divano, TV e pianoforte verticale |
| `caso-soggiorno-pianoforte-tavolo-divano-tv.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, misure e dimensioni reali degli arredi. | Raccolta di planimetria e misure della zona giorno |
| `caso-studio-postazione-lavoro.html` | `images/caso-studio-postazione-lavoro.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 13 luglio 2026 | Studio ricavato in casa con postazione di lavoro da verificare |
| `caso-studio-postazione-lavoro.html` | `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` | Invia planimetria, orientamento delle finestre e posizione prevista della postazione. | Raccolta di planimetria e misure per uno studio in casa |
| `caso-terrazzo-passaggio-arredi.html` | `images/caso-terrazzo-passaggio-arredi.jpg` | Analisi di Gian Carlo Primo · Aggiornato il 13 luglio 2026 | Terrazzo con tavolo, sedie e fioriere da verificare |
...
| `chi-e-sistema90g.html` | `images/12_CHI_SONO_CASO.jpg` | Descrivi gratuitamente il caso e allega il materiale che hai già. La prima valutazione serve a capire se Sistema 90G può esserti utile e qua | Analisi di un caso cucina |
...
| `consulenza-90g.html` | `images/13_SERVIZI_HERO.jpg` | Una decisione principale · prezzo unico 97 € · valutazione iniziale gratuita | Consulenza specialistica per scelte relative alla cucina |
| `consulenza-90g.html` | `images/13_SERVIZI_HERO.jpg` | Con la valutazione iniziale gratuita verifichiamo se basta Consulenza 90G oppure se il problema richiede Verifica o Progetto. | Scelta specialistica per la cucina |
...
| `esempio-fascicolo-cucina.html` | `images/esempio-acquisto-assistito-90g-20260802.jpg` | Questa pagina mostra la funzione del fascicolo più articolato ottenibile aggiungendo Sviluppo avanzato al progetto base. Non rappresenta un  | Esempio illustrativo del fascicolo Progetto Cucina 90G con Sviluppo avanzato |
| `esempio-fascicolo-cucina.html` | `images/08_HOME_CHIUSURA.jpg` | Non devi deciderlo da solo. Sottoponi gratuitamente il caso: verifichiamo se basta il Progetto Cucina 90G base oppure se l'add-on aggiunge v | Cucina sviluppata attraverso un percorso progettuale indipendente |
...
| `esempio-progetto-cucina-90g.html` | `images/08_HOME_CHIUSURA.jpg` | Consulta il perimetro completo del servizio. Prima di acquistare puoi sottoporre gratuitamente la situazione: verifichiamo se Progetto Cucin | Cucina come risultato di una direzione progettuale indipendente |
| `finiture-opache-lucide-cucina.html` | `images/17_SERVIZI_FINITURE.jpg` | La scelta non è solo estetica: cambia il modo in cui si leggono luce, impronte, riflessi e piccoli segni d'uso. | Superfici cucina confrontate alla luce per valutare finiture opache e lucide |
...
| `index.html` | `images/01_HOME_HERO.jpg` | La prima valutazione è gratuita. Sistema 90G non vende cucine, non rappresenta marchi e non riceve provvigioni sulla vendita. | Progettazione indipendente di una cucina prima della scelta del rivenditore |
| `index.html` | `images/progetto-cucina-90g-report-20260817.png` | Progetto base 145 € · nessun vincolo di marchio | Esempio illustrativo di una base progettuale cucina Sistema 90G |
| `index.html` | `images/05_HOME_CASO_1.jpg` | Passaggi, aperture e preventivi mostrano perché una cucina va valutata anche nell'uso reale, non solo nel render. | Lavastoviglie aperta e passaggio |
...
| `index.html` | `images/08_HOME_CHIUSURA.jpg` | Puoi inviare il dubbio e il materiale che hai già. Prima cerchiamo di capire cosa può esserti utile; solo se serve davvero un approfondiment | Progettazione di una cucina prima della scelta del rivenditore |
...
| `lavello-sotto-finestra-cucina.html` | `images/caso-lavello-sotto-finestra-aperture.jpg` | Sì, ma solo se l’apertura reale dell’infisso resta compatibile con rubinetto, piano di lavoro e davanzale. La verifica deve usare quote fini | Lavello sotto finestra con verifica dell |
...
| `metodo-sistema90g.html` | `images/03_HOME_METODO.jpg` | Sistema 90G parte dalla situazione concreta della persona: cosa non funziona, cosa non è chiaro, cosa deve essere deciso. Da lì mette in rel | Analisi e progettazione indipendente di una cucina |
| `metodo-sistema90g.html` | `images/08_HOME_CHIUSURA.jpg` | Puoi partire dal materiale che hai già. La prima valutazione serve a mettere a fuoco il caso e capire quale passo può esserti utile. Solo se | Raccolta materiali per analisi di una cucina |
...
| `progetto-cucina-sistema90g.html` | `images/progetto-cucina-90g-report-20260817.png` | Il progetto base deve essere utile da solo. Gli approfondimenti sono facoltativi e vengono aggiunti solo se servono davvero. | Elaborati del Progetto Cucina Sistema 90G |
| `progetto-cucina-sistema90g.html` | `images/progetto-cucina-90g-report-20260817.png` | Invia ciò che hai e racconta cosa vuoi ottenere. Se basta una Verifica o una Consulenza, te lo diciamo prima di avviare il lavoro. | Progetto Cucina Sistema 90G |
| `proprieta-intellettuale.html` | `images/03_HOME_METODO.jpg` | Ultimo aggiornamento: 23 agosto 2026 | Metodo, criteri e documentazione Sistema 90G |
| `restyling-cucina-esistente.html` | `images/hero-cucina-90g-2026.jpg` | Non devi scegliere tu il servizio prima di spiegare cosa vuoi cambiare. | Restyling di una cucina esistente |
| `restyling-cucina-esistente.html` | `images/hero-cucina-90g-2026.jpg` | La valutazione iniziale è gratuita e serve a capire se il tuo caso richiede Consulenza 90G o Progetto Cucina 90G. | Cucina esistente da rinnovare |
| `rilievo-misure-cucina-prima-ordine.html` | `images/hero-planimetria-90g-2026.jpg` | Sì. Fuori squadra, aperture, spessori, impianti, misure finite, modularità e prodotti scelti possono richiedere adattamenti. La modifica dev | Rilievo misure cucina con quote, pareti e impianti |
| `rinnovare-cucina-senza-cambiarla.html` | `images/hero-cucina-90g-2026.jpg` | Prima di scegliere colori o materiali conviene separare ciò che funziona ancora da ciò che crea davvero il problema. Ante, maniglie, top, sc | Cucina esistente da valutare per un intervento di rinnovo |
...
| `rivenditori-cucine.html` | `images/25_PER_AGENZIE_COLLABORAZIONE.jpg` | Prima di acquistare la verifica puoi sottoporci gratuitamente il caso. Se il supporto è pertinente, sai cosa verrà fatto e a quale prezzo pr | Collaborazione professionale nel processo di acquisto della cucina |
...
| `scelta-finiture-cucina.html` | `images/17_SERVIZI_FINITURE.jpg` | Prima dell'acquisto verifichiamo gratuitamente se questo approfondimento è davvero utile per il materiale e il problema che hai. | Campioni di materiali e finiture cucina |
| `scelta-finiture-cucina.html` | `images/17_SERVIZI_FINITURE.jpg` | Descrivi il progetto e le alternative che stai valutando. Ti diciamo gratuitamente se basta una Consulenza 90G, se l'add-on è coerente oppur | Confronto materiali e finiture cucina |
...
| `verifica-90g.html` | `images/22_CASI_PREVENTIVO.jpg` | Un solo servizio: non devi scegliere tra verifica mirata e completa. | Verifica indipendente di un progetto cucina |
| `verifica-90g.html` | `images/22_CASI_PREVENTIVO.jpg` | Descrivi il problema e allega, quando disponibili, progetto, preventivo, planimetria, foto o misure. | Controllo indipendente di progetto e preventivo |
...
- `cookie-policy.html` — Ultimo aggiornamento: 23 agosto 2026
...
- `index.html` — La prima valutazione è gratuita. Sistema 90G non vende cucine, non rappresenta marchi e non riceve provvigioni sulla vendita.

### `images/03_HOME_METODO.jpg` — 5 utilizzi

- `analisi-preventiva.html` — La prima valutazione è gratuita. Non avvia alcun acquisto e non ti obbliga a proseguire.
...
- `metodo-sistema90g.html` — Sistema 90G parte dalla situazione concreta della persona: cosa non funziona, cosa non è chiaro, cosa deve essere deciso. Da lì mette in rel
- `progettare-cucina-guide.html` — Scopri Progetto Cucina Sistema 90G →
- `proprieta-intellettuale.html` — Ultimo aggiornamento: 23 agosto 2026
...
- `esempio-fascicolo-cucina.html` — Non devi deciderlo da solo. Sottoponi gratuitamente il caso: verifichiamo se basta il Progetto Cucina 90G base oppure se l'add-on aggiunge v
- `esempio-progetto-cucina-90g.html` — Consulta il perimetro completo del servizio. Prima di acquistare puoi sottoporre gratuitamente la situazione: verifichiamo se Progetto Cucin
- `index.html` — Puoi inviare il dubbio e il materiale che hai già. Prima cerchiamo di capire cosa può esserti utile; solo se serve davvero un approfondiment
- `metodo-sistema90g.html` — Puoi partire dal materiale che hai già. La prima valutazione serve a mettere a fuoco il caso e capire quale passo può esserti utile. Solo se

### `images/12_CHI_SONO_CASO.jpg` — 2 utilizzi

- `chi-e-sistema90g.html` — Descrivi gratuitamente il caso e allega il materiale che hai già. La prima valutazione serve a capire se Sistema 90G può esserti utile e qua
- `professionisti-progetto-cucina.html` — Invia il caso per una prima valutazione gratuita. Se serve un approfondimento, servizio, contenuti e prezzo vengono indicati prima di inizia

### `images/13_SERVIZI_HERO.jpg` — 3 utilizzi
...
- `finiture-opache-lucide-cucina.html` — La scelta non è solo estetica: cambia il modo in cui si leggono luce, impronte, riflessi e piccoli segni d'uso.
...
- `scelta-finiture-cucina.html` — Prima dell'acquisto verifichiamo gratuitamente se questo approfondimento è davvero utile per il materiale e il problema che hai.
- `scelta-finiture-cucina.html` — Descrivi il progetto e le alternative che stai valutando. Ti diciamo gratuitamente se basta una Consulenza 90G, se l'add-on è coerente oppur
...
- `casi-analizzati.html` — La prima valutazione serve a capire se e come approfondire. Non avvia automaticamente un servizio a pagamento.
...
### `images/22_CASI_PREVENTIVO.jpg` — 9 utilizzi
...
- `seconda-opinione-cucina.html` — Verifica 90G · 127 € · prezzo chiaro prima di iniziare · nessuna provvigione sulla vendita.
- `seconda-opinione-cucina.html` — Descrivi la situazione e allega ciò che hai. Prima controlliamo se la Verifica 90G è davvero adatta al tuo caso.
- `verifica-90g.html` — Un solo servizio: non devi scegliere tra verifica mirata e completa.
- `verifica-90g.html` — Descrivi il problema e allega, quando disponibili, progetto, preventivo, planimetria, foto o misure.

### `images/25_PER_AGENZIE_COLLABORAZIONE.jpg` — 2 utilizzi

- `agenzie-immobiliari-cucina.html` — La prima valutazione serve a capire gratuitamente se il dubbio sulla cucina è pertinente e quale approfondimento può essere utile. Non attiv
- `rivenditori-cucine.html` — Prima di acquistare la verifica puoi sottoporci gratuitamente il caso. Se il supporto è pertinente, sai cosa verrà fatto e a quale prezzo pr

### `images/28_CONTATTI_RACCOLTA_MATERIALI.jpg` — 30 utilizzi

- `agenzie-immobiliari-cucina.html` — Invia la domanda concreta del cliente e il materiale disponibile. La prima valutazione è gratuita e serve a capire se esiste davvero un appr
...
- `casi-analizzati.html` — L'invio iniziale non attiva alcun acquisto. Se il caso richiede un lavoro professionale, percorso, contenuti e prezzo vengono indicati prima
...
- `caso-camera-bambini-crescita.html` — Invia planimetria, misure della stanza e disposizione prevista di letto, armadio e scrivania.
- `caso-corridoio-porte-aperte.html` — Invia planimetria quotata e verso di apertura previsto per ogni porta.
...
- `caso-garage-apertura-portiere.html` — Invia planimetria, misure del garage e modello dell'auto.
...
- `caso-lavanderia-oblo-porta.html` — Invia planimetria, misure del vano e modello previsto di lavatrice e asciugatrice.
...
- `caso-ripostiglio-profondita-scaffali.html` — Invia planimetria, misure del vano e verso di apertura della porta.
- `caso-scala-interna-terrazzo-planimetria.html` — Invia planimetrie dei livelli, fotografie e obiettivi principali.
...
- `caso-soffitta-altezza-utile.html` — Invia planimetria, sezione della falda e misure dell'accesso.
- `caso-soggiorno-pianoforte-tavolo-divano-tv.html` — Invia planimetria, misure e dimensioni reali degli arredi.
- `caso-studio-postazione-lavoro.html` — Invia planimetria, orientamento delle finestre e posizione prevista della postazione.
...
- `contatti.html` — L'invio del caso serve solo a capire la situazione. Se è utile un lavoro professionale, servizio e prezzo vengono indicati prima di iniziare
...
- `privacy-policy.html` — Ultimo aggiornamento: 23 agosto 2026
...
- `casi-analizzati.html` — Situazioni diverse, con un principio comune: individuare prima il punto che merita davvero attenzione.
- `casi-cucina.html` — 6 casi pubblicati per riconoscere problemi, verifiche e servizi pertinenti.
...
- `lavello-sotto-finestra-cucina.html` — Sì, ma solo se l’apertura reale dell’infisso resta compatibile con rubinetto, piano di lavoro e davanzale. La verifica deve usare quote fini
...
### `images/caso-terza-camera-zona-giorno.jpg` — 2 utilizzi
...
- `restyling-cucina-esistente.html` — La valutazione iniziale è gratuita e serve a capire se il tuo caso richiede Consulenza 90G o Progetto Cucina 90G.
...
- `rilievo-misure-cucina-prima-ordine.html` — Sì. Fuori squadra, aperture, spessori, impianti, misure finite, modularità e prodotti scelti possono richiedere adattamenti. La modifica dev
...
### `images/progetto-cucina-90g-report-20260817.png` — 7 utilizzi

- `acquisto-assistito-cucina.html` — Prima dell'acquisto verifichiamo gratuitamente se lo Sviluppo avanzato aggiunge valore reale oppure se il progetto base è già sufficiente.
- `acquisto-assistito-cucina.html` — Descrivi la situazione e il materiale disponibile. La valutazione iniziale è gratuita: ti diciamo se è sufficiente il Progetto Cucina base o
