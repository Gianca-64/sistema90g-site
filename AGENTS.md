# Sistema 90G - istruzioni per agenti di sviluppo e contenuto
...
I marchi possono essere citati solo quando sono realmente necessari per rispondere a un caso concreto, confrontare in modo indipendente una proposta o chiarire una compatibilita specifica. Le citazioni devono restare neutrali, proporzionate e subordinate al problema dell'utente; evitare pagine dedicate a un singolo marchio salvo una decisione strategica esplicita approvata nella conversazione principale.

## Metodo di lavoro ChatGPT / Codex

Per gli interventi di sviluppo di Sistema 90G, il ragionamento, le decisioni funzionali, la programmazione, l'architettura e la verifica finale restano nella conversazione principale con ChatGPT.

Codex va usato, quando disponibile e opportuno, come operatore per attività semplici, meccaniche o ripetitive già definite: modifiche seriali, sostituzioni controllate, controlli ripetitivi, raccolte e verifiche automatizzabili. Non delegare a Codex decisioni strategiche, progettuali o architetturali non ancora definite.

Prima di applicare modifiche seriali, definire qui il criterio, lavorare su un branch dedicato e verificare il risultato prima di integrare o distribuire in produzione.
